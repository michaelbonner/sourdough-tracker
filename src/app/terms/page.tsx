...
export default function TermsOfService() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-24 prose dark:prose-invert">
      ...
      <section className="space-y-4">
        ...
        <p>
          Sourdough Tracker provides a digital platform for tracking sourdough
          starter maintenance, baking logs, and related data analytics. We
        ...
        <p>
          ...
          way that interrupts, damages, impairs, or renders the service less
          efficient or effective.
        </p>

        <h2>6. Limitation of Liability</h2>
        <p>
          To the maximum extent permitted by law, Sourdough Tracker shall not be
